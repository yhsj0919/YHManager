...
enum ButtonState { Loading, None }

typedef ArgonButtonTap = Function(Function startLoading, Function stopLoading, ButtonState btnState);
...
class _ArgonButtonState extends State<ArgonButton> with TickerProviderStateMixin {
  ...
  ButtonState btn = ButtonState.None;
